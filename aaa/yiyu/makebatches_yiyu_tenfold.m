...
load 'C:\Users\admini\Desktop\aaaaa\depression\woca6.mat'
alldata=data3;
...
% save alldata1
% load alldata1
test_y=alldata(jishuqi*38+1-38:jishuqi*38,end-1:end);%end-1:end);
test_x=alldata(jishuqi*38+1-38:jishuqi*38,1:end-2);%end-2);

alldata(jishuqi*38+1-38:jishuqi*38,:)=[];
train_y=alldata(:,end-1:end);%end-1:end);
train_x=alldata(:,1:end-2);%end-2);
