...
load 'C:\Users\admini\Desktop\aaaaa\zhanghaoshibie\java-shibiezhanghu\niyiyuma.mat'
alldata=data;
...
% save alldata1
% load alldata1
train_x=alldata1(1:300,3:end);%end-2);
test_x=alldata1(301:end,3:end);%end-2);
train_y=alldata1(1:300,1:2);%end-1:end);
test_y=alldata1(301:end,1:2);%end-1:end);
