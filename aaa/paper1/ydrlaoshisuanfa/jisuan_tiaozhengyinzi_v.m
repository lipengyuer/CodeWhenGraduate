function [num_zhuanfa niheyong a h_0 g_0 g_j H_j data4fit]= jisuan_tiaozhengyinzi_v(hezi,geshu)
shichang = 720;
...
for m = 1:9
    log_num_zhunafa1_wukeng(61-6*(m-1)-12            :72+60-6*(m-1)+12,m) = -10*ones(96,1);%zeros(size(log_num_zhunafa1_wukeng(73:120,m)));%%%%%%%%5%%%%%55%%绝对时间
    log_num_zhunafa1_wukeng(61+144-(m-1)*6-12    :132+144-(m-1)*6+12,m) = -10*ones(96,1);%zeros(size(log_num_zhunafa1_wukeng(73:120,m)));
    log_num_zhunafa1_wukeng(61+144*2-(m-1)*6-12  :132+144*2-(m-1)*6+12,m) = -10*ones(96,1);%zeros(size(log_num_zhunafa1_wukeng(73:120,m)));
    log_num_zhunafa1_wukeng(61+144*3-(m-1)*6-12  :132+144*3-(m-1)*6+12,m) = -10*ones(96,1);%zeros(size(log_num_zhunafa1_wukeng(73:120,m)));
...
figure;
hold on,plot(log_num_zhunafa1_wukeng(:,2),'m');hold on,plot(log_num_zhunafa1_wukeng(:,3),'k');hold on,plot(log_num_zhunafa1_wukeng(:,4),'black');hold on,plot(log_num_zhunafa1_wukeng(:,5),'b');hold on,plot(log_num_zhunafa1_wukeng(:,6),'y');hold on,plot(log_num_zhunafa1_wukeng(:,7),'g');
