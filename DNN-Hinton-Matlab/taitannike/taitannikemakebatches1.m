...
% dizhi1='C:\Users\admini\Desktop\NEWB\survivor\shiyan\zong.txt';
% dizhi2='C:\Users\admini\Desktop\NEWB\survivor\shiyan\lablezong.txt';
load C:\Users\admini\Desktop\aaaaa\survivor\labelzong.mat;
load C:\Users\admini\Desktop\aaaaa\survivor\zong.mat;
...
x=data;
y=target;
xuhao=randperm(size(x,1))';
hezi=[xuhao x];
hezi1=[xuhao y];
hezi=sortrows(hezi,1);
hezi1=sortrows(hezi1,1);
train_x=hezi(1:800,2:end);
train_y=hezi1(1:800,2:end);
test_x=hezi(801:end,2:end);
test_y=hezi1(801:end,2:end);
